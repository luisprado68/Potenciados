...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2018 a las 20:20:02
...
`id_ejercicio` int(11) NOT NULL,
  ...
  `ejercicio_5` text COLLATE utf8_spanish_ci NOT NULL,
  `ejercicio_6` text COLLATE utf8_spanish_ci NOT NULL,
  `id_objetivo` int(11) NOT NULL
...
(8, 'Luis Prado', 'luisprado@gmail.com', 'luis123', 65, 171, '1995-08-06', 1, '2018-12-19');
