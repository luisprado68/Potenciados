<div class="midieta">
	<section>
		<div class="img-10">
			...
			<p>Un plan para definir y hacer más visible los músculos, 
				además de tonificar también es necesario reducir al máximo el porcentaje de grasa corporal.</p>
				<?php
	...
	<?php   }
		...
		<?php
			if (isset($_SESSION['usuario'])) {
				...
				$query = "SELECT * FROM `ejercicios` WHERE id_objetivo=3";
