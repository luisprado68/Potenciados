<div class="midieta">
	<section>
		<div class="img-10">
			...
			<p>Un plan que  consta sobre todo de ejercicios básicos complejos que trabajan la integración de los músculos grandes,
			aumentando progresivamente la fuerza.</p>
			<?php
	...
	<?php   }
		...
		?>
			...
			if (isset($_SESSION['usuario'])) {
				...
				$query = "SELECT * FROM `ejercicios` WHERE id_objetivo=2";
